...
from config import CACHE_DIR, SLEEP_SECONDS

HEADERS = {
    "User-Agent": "Mozilla/5.0 (compatible; FightIQBot/2.0; +https://github.com/thomasmuscat/fightIQ)",
...
def soup_from_url(url: str, use_cache: bool = True) -> BeautifulSoup:
